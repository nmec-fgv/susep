...
if __name__ == '__main__':
    ...
    est_poi = {}
    est_poi['Poi_month'] = Poi_month 
    est_poi['Poi_quarter'] = Poi_quarter


    try:
        os.remove('/home/ricardob/Susep/Data/est_poi_tot.pkl')
    except OSError:
        pass

    with open('/home/ricardob/Susep/Data/est_poi_tot.pkl', 'wb') as file:
