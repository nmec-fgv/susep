###########################################################
## Código para inserção de valores nas tabelas r_endosso ##
###########################################################
...
sql_code = r'''
DROP TABLE IF EXISTS r_endosso_:xxx;

CREATE TABLE r_endosso_:xxx (
    cod_apo,
    endosso,
    cod_end,
    item,
...
for tab in tables:
    ...
    cur.execute(sql['tab'])
    print('Tabela r_endosso_' + tab + ' carregada com sucesso')
